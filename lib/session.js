...
// it's an array of keys        
  ...
  Session.prototype.query = function (type, specifications, callback) {
    if (!type) {
      return;
    }
    ...
    var query = this._buildQuery(masks.dynamic, (plural.charAt(0).toUpperCase() + plural.slice(1)), specifications);
