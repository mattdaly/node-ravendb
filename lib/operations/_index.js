...
module.exports = (function() {
  return function (index, parameters, projections, sort, connection, callback) {
    ...
    http.get(options, function (response) {
      ...
      if (response.statusCode === 400) {
        error = new Error('Index Query Failed: The request url was badly formed. Ensure none of the parameters contain illegal characters');
