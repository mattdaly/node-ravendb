...
exports.generate = function (document, seperator, generator, callback) {
  ...
  if (document['@conventions']) {
    if (document['@conventions']['idSeparator']) { seperator = document['@conventions']['idSeparator']; }
    if (document['@conventions']['idGenerationStrategy']) { generator = document['@conventions']['idGenerationStrategy']; }
  }
